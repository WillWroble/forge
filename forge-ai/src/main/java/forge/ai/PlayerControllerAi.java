...
public class PlayerControllerAi extends PlayerController {
    ...
    public CardCollectionView orderMoveToZoneList(CardCollectionView cards, ZoneType destinationZone, SpellAbility source) {
        ...
        if (destinationZone == ZoneType.Graveyard) {
            ...
            int landsOTB = CardLists.count(p.getCardsIn(ZoneType.Battlefield), Presets.LANDS_PRODUCING_MANA);
    ...
    public String chooseKeywordForPump(final List<String> options, final SpellAbility sa, final String prompt, final Card tgtCard) {
        ...
        CardCollection oppUntappedCreatures = CardLists.filter(player.getOpponents().getCreaturesInPlay(), Presets.UNTAPPED);
        if (tgtCard != null) {
    ...
    public boolean chooseCardsPile(SpellAbility sa, CardCollectionView pile1, CardCollectionView pile2, String faceUp) {
        if (faceUp.equals("True")) {
            ...
            boolean allCreatures = Iterables.all(Iterables.concat(pile1, pile2), Presets.CREATURES);
